...
import { fetchGraph, fetchManualTriggers, FetchSubmission, HandleCreateFlowGraph, LazyLoadGraph, LazyLoadNodeHistory, LazyLoadNodeSchema, submitEvent, SubmitForm } from '../api';
...
const ApprovalGraph: React.FC<ApprovalGraphProps> = (props : ApprovalGraphProps) => {
  ...
  }, [props.graphId, props.requestId, setNodes, setEdges, graphData]);
