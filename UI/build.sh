...
# Set variables
TAG_SHA="ui_erp:$(git rev-parse --short HEAD 2>/dev/null || echo "latest")"
...
build_dev() {
  echo "Building development image: ui_erp:dev"
  docker build -f Dockerfile.dev -t ui_erp:dev $BUILD_ARGS .
